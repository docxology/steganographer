...
| ---- | ---- | ----------- |
| `steganographer-core/` | Crate | Pure algorithms: generic packets/carriers, LSB video/audio, crypto, overlays, signing, metrics, config, frequency-domain kernels, encryption, ECC, multi-frame, adaptive, hash-chain, KDF, and steganalysis (23 modules, 238 unit tests, 113 integration tests) |
...
- **Tests**: 238 core unit + 113 core integration + 6 CLI unit + 20 CLI integration + 23 dashboard + 2 GStreamer/doc = **402 passing tests**
...
cargo test -p steganographer-core              # 351 tests (238 unit + 113 integration, Ed25519 default)
cargo test -p steganographer-core --features ethereum  # includes Ethereum tests
cargo test --workspace                         # 402 total tests
